...
def apply_color_palette(palette_key="purple", appearance_mode="dark"):
    """Update the shared color tokens in-place so every UI module shares one theme."""
    palette = THEME_PALETTES.get(palette_key, THEME_PALETTES["purple"])
    mode = "light" if appearance_mode == "light" else "dark"
    ...
    COLORS.update({
        ...
        "white": "#FFFFFF",
        "blue": "#3B82F6", "green": "#22C55E", "orange": "#F59E0B", "red": "#EF4444", "pink": "#EC4899",
    })

# These colors are used for user-created subjects.  They are deliberately
# saturated enough to remain distinct on the dark application background.
